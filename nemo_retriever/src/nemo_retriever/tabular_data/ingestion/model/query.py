...
from nemo_retriever.tabular_data.ingestion.graph.model.reserved_words import Labels, SQLType, SQL, Props, Parser
from typing import Union, Type, Self
import pendulum
from nemo_retriever.tabular_data.ingestion.graph.utils import flat_list_recursive
...
def get_tables_recursive(query_tables):
    ...
    return list(set(tables + flat_list_recursive(tables_from_subqueries)))
...
class Query:
    ...
    def find_column_node(self, column_name):
        ...
        for table_name, table_node in tables:
            ...
            elif table_node.label == Labels.TABLE:
