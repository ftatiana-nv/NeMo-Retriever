...
from nemo_retriever.tabular_data.ingestion.graph.parsers.sql import sql_view_parser
...
from nemo_retriever.tabular_data.ingestion.graph.parsers.sql.queries_parser import parse_single
