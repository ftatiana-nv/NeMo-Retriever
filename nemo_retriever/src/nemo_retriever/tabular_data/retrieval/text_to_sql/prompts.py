...
create_sql_user_prompt = (
    ...
    "(if present), tables and foreign keys(if present).\n"
    ...
    "CONFUSION.\n"
    "- MOST CRITICAL: Always use joins from the foreign keys "
    "provided in the prompt although it is not the shortest "
    "path, NEVER create new joins!\n"
    ...
    "columns, then join them using the foreign keys provided "
    "in the prompt. don't mix fields from different foreign "
    "keys pairs.\n"
