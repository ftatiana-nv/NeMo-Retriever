...
def generate_sql(query: str, embedding_api_key: str = "", top_k: int = 15) -> str:
    """Generate SQL for a natural language query; returns the sql_code string."""
    result = get_sql_tool_response_top_k(query, embedding_api_key=embedding_api_key, top_k=top_k)
