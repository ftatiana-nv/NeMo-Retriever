#!/usr/bin/env python3
"""Local debug script to run run_mode_ingest (tabular path). Part of tabular_data.

Run from repo root:
  PYTHONPATH=nemo_retriever/src python -m nemo_retriever.tabular_data.debug_run_mode_ingest

List embedding models for your NVIDIA API key:
  PYTHONPATH=nemo_retriever/src python -m nemo_retriever.tabular_data.debug_run_mode_ingest --list-models
