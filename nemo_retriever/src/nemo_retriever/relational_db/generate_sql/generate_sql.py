...
def generate_sql(query: str, top_k: int = 15) -> str:
    """Generate SQL for a natural language query. Retrieves top_k tables from LanceDB, then asks the LLM.
    Returns the SQL code string only."""
    ...
    return (result_dict.get("sql_code") or "").strip() or ""
